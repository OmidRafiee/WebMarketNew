...
namespace WebMarket.ServiceLayer.Interfaces
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        //my Custom method
        IEnumerable<string> GetAllEmail();
        IEnumerable<string> GetAllUserName();

        IList<DetailsUserViewModel> GetDataTable(out int total,
                                                                    string term ,
                                                                    int page ,
                                                                    int count ,
                                                                    DomainClasses.Enums.Order order ,
                                                                    DomainClasses.Enums.UserOrderBy orderBy ,
                                                                    DomainClasses.Enums.UserSearchBy searchBy );
