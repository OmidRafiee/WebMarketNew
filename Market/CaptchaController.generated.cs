...
namespace Market.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CaptchaController : Market.Controllers.CaptchaController
    {
        public T4MVC_CaptchaController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CaptchaImageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string prefix, bool noisy);
        ...
        public override System.Web.Mvc.ActionResult CaptchaImage(string prefix, bool noisy)
        {
            ...
            CaptchaImageOverride(callInfo, prefix, noisy);
            return callInfo;
        }
